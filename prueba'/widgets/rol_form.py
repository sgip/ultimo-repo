...
class RolForm(TableForm):
    ...
    opciones_permisos = DBSession.query(Permission.permission_id, Permission.permission_name).filter_by(permission_type='sistema').order_by(Permission.permission_id)
