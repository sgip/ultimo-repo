...
class Fase(DeclarativeBase):
    ...
    def __repr__(self):
        return ('<Fase: id=%r, name=%r, descripcion=%r, orden=%r' % (
               self.codfase, self.nombre, self.descripcion, self.orden)).encode('utf-8')
    def __unicode__(self):
        return self.nombre
    def __cmp__( self, other ):
	if self.codfase < other.codfase:
        	rst = -1
      	elif self.codfase > other.codfase:
        	rst = 1
      	else:
        	rst = 0
	return rst
...
class Tipoitem(DeclarativeBase):
    ...
    nombre = Column(u'nombre', String(20), nullable=False)
    codificacion = Column(u'codificacion', String(6), nullable=False)
    ultimo = Column(u'ultimo', Integer, nullable=False)
...
class Item(DeclarativeBase):
    ...
    lineabase = relation('Lineabase', backref='items')
...
class ArchivoExterno(DeclarativeBase):
    ...
    coditem = Column(u'coditem', Integer, ForeignKey('item.coditem'))
